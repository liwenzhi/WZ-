...
import com.liwenzhi.aib.util.DisplayUtils;
...
public class RoundProgressBar extends View {
    ...
    public RoundProgressBar(Context context, AttributeSet attrs, int defStyle) {
        ...
        //获取自定义属性和默认值
        // 最大圆的颜色(默认是透明黑)
        roundColor = mTypedArray.getColor(R.styleable.RoundProgressBar_roundColor, getResources().getColor(R.color.black_translucent));
        // 中心笑小圆环颜色(默认是白色)
        roundProgressColor = mTypedArray.getColor(R.styleable.RoundProgressBar_roundProgressColor, getResources().getColor(R.color.white));
        // 进度圆环颜色(默认是橙色)
        mProgressColor = mTypedArray.getColor(R.styleable.RoundProgressBar_progressColor, getResources().getColor(R.color.blue_main));
        // 文本颜色(默认是白色)
        textColor = mTypedArray.getColor(R.styleable.RoundProgressBar_textColor, Color.WHITE);
        // 文本大小(默认是14sp)
        textSize = mTypedArray.getDimensionPixelOffset(R.styleable.RoundProgressBar_textSize, DisplayUtils.sp2px(14));
