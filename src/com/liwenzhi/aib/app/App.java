package com.liwenzhi.aib.app;

import android.app.Application;
import cat.ereza.customactivityoncrash.CustomActivityOnCrash;
import cat.ereza.customactivityoncrash.config.CaocConfig;
import com.liwenzhi.aib.R;
import com.liwenzhi.aib.ui.activity.CustomErrorActivity;
import com.liwenzhi.aib.ui.activity.MainActivity;
...
//        mRefWatcher = LeakCanary.install(this);
    ...
    private static class CustomEventListener implements CustomActivityOnCrash.EventListener {
        ...
        public void onLaunchErrorActivity() {
            CommonUtils.e("onLaunchErrorActivity()");
        }

        //重启程序时回调
        @Override
        public void onRestartAppFromErrorActivity() {
            CommonUtils.e("onRestartAppFromErrorActivity()");
        ...
        public void onCloseAppFromErrorActivity() {
            CommonUtils.e("onCloseAppFromErrorActivity()");
        }
